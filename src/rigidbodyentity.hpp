...
class RigidBodyEntity {
    public:
        ...
        RigidBodyEntity(Model entityModel, btVector3 defaultPos = btVector3(0,100,0), CollisionShapeType collisionShapeType = BOX, float mass = 1.0, btVector3 boxShape = btVector3(1.0, 1.0, 1.0));
